...
class Constants:
    ...
    REST_URL = "https://api.pro.changelly.com/api/2"
    REST_URL_AUTH = "/api/2"
    WS_PRIVATE_URL = "wss://api.pro.changelly.com/api/2/ws/trading"
    WS_PUBLIC_URL = "wss://api.pro.changelly.com/api/2/ws/public"
    ...
    UPDATE_ORDER_STATUS_INTERVAL = 5.0
