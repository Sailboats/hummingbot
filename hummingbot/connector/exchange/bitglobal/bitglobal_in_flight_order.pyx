...
cdef class BitglobalInFlightOrder(InFlightOrderBase):
    ...
    def __init__(self,
        ...
        self.logger().debug('__init__: client_order_id = {client_order_id}, exchange_order_id = {exchange_order_id}, trading_pair = {trading_pair}, order_type = {order_type}, trade_type = {trade_type}, price = {price}, amount = {amount}, initial_state = {initial_state}')
        super().__init__(
            client_order_id,
            exchange_order_id,
            trading_pair,
