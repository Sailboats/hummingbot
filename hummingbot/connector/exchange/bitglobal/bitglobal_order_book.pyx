...
cdef class BitglobalOrderBook(OrderBook):
    @classmethod
    ...
    def diff_message_from_exchange(cls,
        ...
        return OrderBookMessage(OrderBookMessageType.DIFF, {
            ...
            "first_update_id": int(msg["ver"]),
            "update_id": int(msg["ver"]),
            "bids": msg["b"],
            "asks": msg["s"]
        }, timestamp=timestamp)
    ...
    def trade_message_from_exchange(cls, msg: Dict[str, any], metadata: Optional[Dict] = None):
        ...
        return OrderBookMessage(OrderBookMessageType.TRADE, {
            "trading_pair": msg["symbol"],
            "trade_type": float(TradeType.SELL.value) if msg["s"] == "buy" else float(TradeType.BUY.value),
            "trade_id": msg["t"],
            "update_id": msg["t"],
            "price": msg["p"],
            "amount": msg["v"]
